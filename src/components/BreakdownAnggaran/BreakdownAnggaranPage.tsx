...
const BreakdownAnggaranPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 p-6 overflow-hidden">
            ...
            {/* Filters */}
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6 flex flex-wrap gap-4 items-center z-20 relative">
            ...
            {/* Chart Area */}
            <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-200 p-6 relative flex flex-col min-h-[400px]">
                {loading ? (
                    ...
                    <div className="w-full h-full min-h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart
                                ...
                                layout="horizontal" // Use vertical bars
                            >
