...
const Header: React.FC<HeaderProps> = ({ toggleSidebar }) => {
    return (
        <header className="h-24 bg-gradient-to-r from-lobar-red to-red-800 text-white shadow-md flex items-center justify-between px-4 z-20 relative">
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    <img src="/logo_lombok_barat.png" alt="Logo Lombok Barat" className="h-12 w-auto drop-shadow-md" />
                    <div>
            ...
            <div className="flex items-center gap-3">
                <img src="/logo_kerja_nyata.png" alt="Logo Kerja Nyata" className="h-20 w-auto object-contain drop-shadow-sm" />
